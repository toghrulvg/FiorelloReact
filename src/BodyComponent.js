    ...
    <div>
        ...
        <section id="slider">
            <div class="owl-carousel slider">
                <div> <img src="img/h3-slider-background.jpg" alt=""></img> </div>
                <div> <img src="img/h3-slider-background-2.jpg" alt=""> </img></div>
                <div> <img src="img/h3-slider-background-3.jpg" alt=""></img> </div>
            </div>
            <div class="container context pl-lg-5 ml-lg-3">
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <div class="img">
                            <img src="img/h2-sign-img.png" alt=""></img>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                        <div class="product-item text-center" data-id="popular">
                            <div class="img">
                                <a href="">
                                    <img src="img/shop-14-img.jpg" class="img-fluid" alt=""></img>
                                </a>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                        <div class="product-item text-center" data-id="popular">
                            <div class="img">
                                <a href="">
                                    <img src="img/shop-13-img.jpg" class="img-fluid" alt=""></img>
                                </a>
                            </div>
                            <div class="title mt-3">
                                <h6>MAJESTY PALM</h6>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                        <div class="product-item text-center" data-id="winter">
                            <div class="img">
                                <a href="">
                                    <img src="img/shop-12-img.jpg" class="img-fluid" alt=""></img>
                                </a>
                            </div>
                            <div class="title mt-3">
                                <h6>MAJESTY PALM</h6>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                        <div class="product-item text-center" data-id="winter">
                            <div class="img">
                                <a href="">
                                    <img src="img/shop-11-img.jpg" class="img-fluid" alt=""></img>
                                </a>
                            </div>
                            <div class="title mt-3">
                                <h6>MAJESTY PALM</h6>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                        <div class="product-item text-center" data-id="various">
                            <div class="img">
                                <a href="">
                                    <img src="img/shop-10-img.jpg" class="img-fluid" alt=""></img>
                                </a>
                            </div>
                            <div class="title mt-3">
                                <h6>MAJESTY PALM</h6>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                        <div class="product-item text-center" data-id="various">
                            <div class="img">
                                <a href="">
                                    <img src="img/shop-9-img.jpg" class="img-fluid" alt=""></img>
                                </a>
                            </div>
                            <div class="title mt-3">
                                <h6>MAJESTY PALM</h6>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                        <div class="product-item text-center" data-id="exotic">
                            <div class="img">
                                <a href="">
                                    <img src="img/shop-8-img.jpg" class="img-fluid" alt=""></img>
                                </a>
                            </div>
                            <div class="title mt-3">
                                <h6>MAJESTY PALM</h6>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 mt-3">
                        <div class="product-item text-center" data-id="exotic">
                            <div class="img">
                                <a href="">
                                    <img src="img/shop-7-img.jpg" class="img-fluid" alt=""></img>
                                </a>
                            </div>
                            <div class="title mt-3">
                                <h6>MAJESTY PALM</h6>
        ...
        <section id="about">
            <div class="container py-5">
                <div class="row py-5">
                    <div class="col-lg-6">
                        <div class="img">
                            <img src="img/h3-video-img.jpg" class="img-fluid" alt=""></img>
                            <div
                    ...
                    <div class="col-lg-6">
                        <div class="about-text mt-5 mt-lg-0 px-lg-5">
                            ...
                            <p class="py-3">Where flowers are our inspiration to create lasting memories. Whatever the
                                occasion...</p>
                            <ul class="list-unstyled">
                                <li class="mt-3"><img src="img/h1-custom-icon.png" class="mr-2" alt=""></img> Hand picked just
                                    for you.</li >
                                <li class="mt-3"><img src="img/h1-custom-icon.png" class="mr-2" alt=""></img> Unique flower
                                    arrangements</li>
                                <li class="mt-3"><img src="img/h1-custom-icon.png" class="mr-2" alt=""></img> Best way to say
                                    you care.</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row pb-5">
                    <div class="col-md-6 col-lg-3">
                        <div class="item text-center">
                            <div class="img">
                                <img src="img/h3-team-img-1.png" class="img-fluid rounded-circle" alt=""></img>
                            </div>
                            <div class="text mt-3">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="item text-center">
                            <div class="img">
                                <img src="img/h3-team-img-2.png" class="img-fluid rounded-circle" alt=""></img>
                            </div>
                            <div class="text mt-3">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="item text-center">
                            <div class="img">
                                <img src="img/h3-team-img-3.png" class="img-fluid rounded-circle" alt=""></img>
                            </div>
                            <div class="text mt-3">
                                <h6>BEVERLY CLARK</h6>
                                <p class="text-black-50">Florist</p>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="item text-center">
                            <div class="img">
                                <img src="img/h3-team-img-4.png" class="img-fluid rounded-circle" alt=""></img>
                            </div>
                            <div class="text mt-3">
                    ...
                    <div class="col-12">
                        <div class="content text-center py-5">
                            ...
                            <div class="form-group d-flex justify-content-center flex-wrap mt-5">
                                <input type="email" placeholder="Email Address" class="form-control-lg rounded-0"></input>
            ...
            <div class="container">
                ...
                <div class="row pb-5">
                    <div class="col-md-6 col-lg-4">
                        <div class="item">
                            <div class="img position-relative">
                                <img src="img/blog-feature-img-1.jpg" class="img-fluid" alt=""></img>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="item">
                            <div class="img position-relative">
                                <img src="img/blog-feature-img-3.jpg" class="img-fluid" alt=""></img>
                                <div class="date rounded bg-light position-absolute py-1 px-2">
                                    <span>29.12.2019</span>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="item">
                            <div class="img position-relative">
                                <img src="img/blog-feature-img-4.jpg" class="img-fluid" alt=""></img>
                                <div class="date rounded bg-light position-absolute py-1 px-2">
                                    <span>29.12.2019</span>
                                </div>
                            </div>
                    ...
                    <div class="col-md-8 col-xl-6">
                        <div class="owl-carousel say">
                            <div>
                                <div class="item text-center">
                                    <div class="img d-flex justify-content-center">
                                        <img src="img/testimonial-img-1.png" alt=""></img>
                                    </div>
                            ...
                            <div>
                                <div class="item text-center">
                                    <div class="img d-flex justify-content-center">
                                        <img src="img/testimonial-img-2.png" alt=""></img>
                                    </div>
                                    <div class="text text-muted pt-3 pb-5">
        ...
        <section id="instagram">
            <div class="owl-carousel instagram">
                <div><img src="img/instagram1.jpg" class="img-fluid" alt=""></img></div>
                <div><img src="img/instagram2.jpg" class="img-fluid" alt=""></img></div>
                <div><img src="img/instagram3.jpg" class="img-fluid" alt=""></img></div>
                <div><img src="img/instagram4.jpg" class="img-fluid" alt=""></img></div>
                <div><img src="img/instagram5.jpg" class="img-fluid" alt=""></img></div>
                <div><img src="img/instagram6.jpg" class="img-fluid" alt=""></img></div>
                <div><img src="img/instagram7.jpg" class="img-fluid" alt=""></img></div>
                <div><img src="img/instagram8.jpg" class="img-fluid" alt=""></img></div>
            </div>
